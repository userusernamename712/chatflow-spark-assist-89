  ...
  return (
    <div className="flex items-center justify-between p-3 border-b bg-white shadow-sm">
      <div className="flex items-center space-x-3">
        <div className="relative bg-[var(--primary--color-medium)] p-2 rounded-full">
      ...
      <div className="flex items-center text-xs px-3 py-1 rounded-full bg-[var(--status-succes-light)]">
